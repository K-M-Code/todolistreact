...
function App() {
  ...
  const fetchBooks = () => {
    fetch('https://todolist-f614a-default-rtdb.europe-west1.firebasedatabase.app/books/.json')
  ...
  const deleteBook = (id) => {
    fetch(`https://todolist-f614a-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`, {
      method: 'DELETE',
    })
    .then(response => fetchBooks())
    .catch(err => console.error(err));
